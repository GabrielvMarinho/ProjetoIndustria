...
Revision ID: f58b97d08e01
Revises: 
Create Date: 2024-10-14 21:21:58.770590
...
def upgrade():
    ...
    sa.Column('mensagemMax', sa.Text(), nullable=True),
    sa.Column('minDict', sa.JSON(), nullable=True),
    sa.Column('mensagemMin', sa.Text(), nullable=True),
